...
<div id="page">
    <header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner"
            style="background-image:url(images/FotoJet.png);" data-stellar-background-ratio="0.5">
                ...
                <div class="col-md-8 col-md-offset-2 text-center">
                    <div class="display-t js-fullheight">
                        <div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
                            ...
                            @php
                                $user = \Illuminate\Support\Facades\Auth::guard('web_employee')->user();
                                $name = $user -> e_name;
                                $code = $user ->e_codename;
                                $mail = $user ->email;
                                $des = $user -> e_designation;
                            @endphp
                            <h1><span>{{$name}}</span></h1>
                            <h3><span>{{$des}}</span></h3>
                            <p>
                            <ul class="fh5co-social-icons">
                                <li><a href="addBook"><i class="icon-add-to-list"></i></a></li>
                                <li><a href="manageBook"><i class="icon-books"></i></a></li>
                                <li><a href="manageRequest"><i class="icon-library"></i></a></li>
                                <li><a href="/manageBooks/trackReturn"><i class="icon-history"></i> </a> </li>
                            </ul>
                            </p></div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="col-md-6"><h2>About Me</h2>
                <ul class="info">
                    ...
                    <li class="btn-block">   <form action="employee_logout" method="post" class="btn-circle" >
                            @csrf
