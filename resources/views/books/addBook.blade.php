    ...
    <div id="content-wrapper" class="d-flex flex-column"><!-- Main Content -->
        <div id="content"><!-- Begin Page Content -->
            <div class="container-fluid"><!--Session Message-->@if(session('info'))
                    ...
                    <div class="col-xl-12 col-lg-7">
                        <div class="card shadow mb-4"><!-- Card Header - Dropdown -->
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between"><h6
                                        class="m-0 font-weight-bold text-primary">Add Books</h6></div><!-- Card Body -->
                            <div class="card-body">
                                <form method="post" action="{{url('/insertBook')}}">{{csrf_field()}}
                                    <fieldset>
                                        <div class="form-group"><label for="exampleInputEmail1">Title :</label><input
                                                    type="text" name="title" class="form-control" id="title"
                                                    aria-describedby="emailHelp" placeholder="Enter Title"></div>
                                        <div class="form-group"><label for="exampleInputEmail1">ISBN :</label><input
                                                    type="text" name="ISBN_code" class="form-control" id="ISBN_code"
                                                    aria-describedby="emailHelp" placeholder="Enter ISBN code"></div>
                                        <div class="form-group"><label for="exampleInputEmail1">Author :</label><input
                                                    type="text" name="author" class="form-control" id="author"
                                                    aria-describedby="emailHelp" placeholder="Enter Author's Name">
                                        </div>
                                        <div class="form-group"><label for="exampleInputEmail1">Edition :</label><input
                                                    type="number" name="edition" class="form-control" id="edition"
                                                    aria-describedby="emailHelp" placeholder="Enter Edition Number">
                                        </div><!--DIV-->
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group"><label for="exampleInputEmail1">No Of Copies
                                                        :</label><input type="number" name="noOfCopy"
                                                                        class="form-control" id="noOfCopy"
                                                                        aria-describedby="emailHelp"
                                                                        placeholder="Enter Number of Copies"></div>
                                            </div>
                ...
                </div><!-- /.container-fluid --></div><!-- End of Main Content --><!-- End of Footer --></div>
